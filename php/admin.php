...
<!-- Espace resseaux sociaux -->
    ...
    <main>
        <nav class="nav">
            ...
            <div class="nav__btn">
                <a href="../connect.html"><button> Disconnect</button></a>
            </div>
        </nav>
    <section class="admin">
    ...
    <section class="options">
            <div class="options__cuisinier">
                    <div class="options__cuisinier__chief">
                        <div>
                            <img src="../assets/img/chef6.png" alt="">
                        </div>
                        <div>
                            <input type="submit" value="Add chef" onclick="openFormChef()">
                        </div>
                    </div>
            </div>

            <div class="options__modifier">
                     <div class="options__cuisinier__chief">
                        <div>
                        ...
                        <div>
                            <form action="deleteChef.php" method="post">
                                <input type="submit" value="See chef">
                            </form>
                        </div>
                    </div>  
            ...
            <div class="options__voir">
                    <div class="options__cuisinier__chief">
                        <div>
                            <img src="../assets/img/serveur.jpg" alt="">
                        </div>
                        <div>
                            <a href="../php/addAdminOnDataBase.php"><input type="submit" value="Add admin"></a>
                        </div>
                    </div>
            </div>
            ...
            <div class="options__supprimer">
                    <div class="options__cuisinier__chief">
                        <div>
                            <img src="../assets/img/Group 68.jpg" alt="">
                        </div>
                        <div>
                        <form action="deleteAdmin.php" method="post">
                            <input type="submit" value="See admin">
                        </form>
