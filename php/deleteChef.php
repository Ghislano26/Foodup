...
<table>
    ...
    $reponse = $connexion->query('SELECT * FROM chiefs');
     ...
     while ($donnees = $reponse->fetch()) {
        ...
        <tr>
            <td style="background-color: white; color: black;">'.$donnees['name'].'</td>
            <td style="background-color: white; color: black;">'.$donnees['lastname'].'</td>
            <td style="background-color: white; color: black;">'.$donnees['address'].'</td>
            <td style="background-color: white; color: black;">'.$donnees['age'].'</td>
            <td style="background-color: white; color: black;">'.$donnees['country'].'</td>
            <td style="background-color: white; color: black;"><a href="modifChef.php?numChefModif='.$donnees['id'].'"><img src="../assets/img/pen-to-square-solid.svg" alt="" style="width: 40px;";></td>
            <td style="background-color: white; color: black;"><a href="delete.php?numChef='.$donnees['id'].'"><img src="../assets/img/trash-can-regular.svg" alt="" style="width: 40px;";></a></td>
