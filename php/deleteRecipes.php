...
<table>
    ...
    $reponse = $connexion->query('SELECT * FROM recettes');

     while ($donnees = $reponse->fetch()) {
        echo '
        
        <tr>
            <td style="background-color: white; color: black;">'.$donnees['auteur'].'</td>
            <td style="background-color: white; color: black;">'.$donnees['recipes'].'</td>
            <td style="background-color: white; color: black;">'.$donnees['date'].'</td>
            <td style="background-color: white; color: black;">'.$donnees['ingredient'].'</td>
            <td style="background-color: white; color: black;">'.$donnees['vue'].'</td>
            <td style="background-color: white; color: black;">
                <a href="modifRecipes.php?numRecipes='.$donnees['id'].'"><img src="../assets/img/pen-to-square-solid.svg" alt="" style="width: 40px;";></a>
            </td> 
...
?> 
                ...
                <div class="form__choise">
                    <a href="chef.php"><input type="submit" value="Chief page"></a>
                </div>
