<?php 
     ...
     $test = $connexion->prepare('SELECT * FROM admin WHERE id=:num');
 
     $test->bindValue(':num', $_GET['numAdmin'], PDO::PARAM_INT);
...
<section class="formulaire" id="formChefAdd">
        ...
        <form action="updateAdmin.php" method="post">
            ...
            <input type="hidden" name="numAdmin"  value="<?php echo $mod['id']?>">
            <div class="form__name">
                    <label for="name">Name</label> <br><br>
                    <input value="<?php echo $mod['nom']?>" type="text" id="name" name="name" placeholder="****name" required autocomplete="off">
                    <br><span id="chefNames"></span>
            </div>

            <div class="form__lastname">
                    <label for="lastname">Lastname</label> <br><br>
                    <input value="<?php echo $mod['prenom']?>" type="text" id="lastname" name="lastname" placeholder="****lastname" required autocomplete="off">
            </div>

            <div class="form__email">
                    <label for="mail">E-mail</label> <br><br>
                    <input value="<?php echo $mod['email']?>" type="mail" id="mail" name="mail" placeholder="****ghislano26@gmail.com" required autocomplete="off">
            </div>
